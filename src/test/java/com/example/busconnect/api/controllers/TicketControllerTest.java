...
import com.example.busconnect.domine.entities.enums.PaymentMethod;
...
class TicketControllerTest {
    ...
    @BeforeEach
    void setUp() {
        BusInfoDto busInfo = new BusInfoDto(
                1L,
                "ABC-123",
                40,
                "ACTIVE"
        ...
        StopInfoDto fromStopInfo = new StopInfoDto(
                1L,
                "Bogotá",
                1,
        ...
        StopInfoDto toStopInfo = new StopInfoDto(
                2L,
                "Tunja",
                2,
                new BigDecimal("5.5353300"),
                new BigDecimal("-73.3678100"),
                1L
        );
    ...
    void cancelTicket_ShouldCancelAndReturnTicket() throws Exception {
        TicketResponse cancelledResponse = new TicketResponse(
                ...
                "FLEXIBLE",
                ticketResponse.trip(),
                ticketResponse.fromStop(),
                ticketResponse.toStop()
        );
    ...
    void getTicketWithDetails_ShouldReturnTicketWithDetails() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/tickets/1/details"))
                ...
                .andExpect(jsonPath("$.fromStop").exists())
                .andExpect(jsonPath("$.toStop").exists());
