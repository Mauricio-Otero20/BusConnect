...
import com.example.busconnect.domine.entities.enums.*;
...
class TicketMapperTest {
    ...
    void shouldGenerateUniqueQrCodes() {
        TicketCreateRequest request = new TicketCreateRequest(
                1L, 2L, 3L, 4L, "1A", new BigDecimal("45000"), PaymentMethod.CASH
        );
    ...
    void shouldMapAllPaymentMethodTypes() {
        for (PaymentMethod method : PaymentMethod.values()) {
            TicketCreateRequest request = new TicketCreateRequest(
                    1L, 2L, 3L, 4L, "1A", new BigDecimal("45000"), method
            );
    ...
    void shouldHandleQrCodeGenerationForDifferentTrips() {
        ...
        TicketCreateRequest request2 = new TicketCreateRequest(
                5L, 2L, 3L, 4L, "2B", new BigDecimal("45000"), PaymentMethod.CARD
        );
    ...
    void shouldHandleDifferentSeatNumbersInQr() {
        ...
        for (String seatNumber : seatNumbers) {
            TicketCreateRequest request = new TicketCreateRequest(
                    1L, 2L, 3L, 4L, seatNumber,new BigDecimal("45000"), PaymentMethod.CASH
            );
    ...
    void shouldPreserveAllFieldsDuringFullCycleMapping() {
        TicketCreateRequest request = new TicketCreateRequest(
                100L, 200L, 300L, 400L, "VIP-1", new BigDecimal("150000"), PaymentMethod.QR
        );
