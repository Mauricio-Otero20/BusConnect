...
public class AssignmentServiceImpl implements AssignmentService {
    ...
    public AssignmentResponse createAssignment(AssignmentCreateRequest request) {
        ...
        dispatcher.getRole() != UserRole.ADMIN) {
        throw new IllegalArgumentException(
            "User " + dispatcher.getId() + " must be DISPATCHER or ADMIN to create assignments"
        );
    }
...
public AssignmentResponse updateAssignment(Long id, AssignmentUpdateRequest request) {
    ...
    if (request.driverId() != null) {
        ...
        if (newDriver.getRole() != UserRole.DRIVER) {
            throw new IllegalArgumentException("User " + newDriver.getId() + " is not a DRIVER");
        }
    ...
    Assignment assignmentWithDetails = assignmentRepository
        .findByIdWithDetails(updatedAssignment.getId())
        .orElse(updatedAssignment);
    
    return assignmentMapper.toResponse(assignmentWithDetails);
}
